...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image1', models.ImageField(default='default/product.jpg', null=True, upload_to='products')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(default='default/shop.jpg', null=True, upload_to='shops')),
                ('cover', models.ImageField(default='default/cover.jpg', null=True, upload_to='cover')),
                ('name', models.CharField(max_length=100)),
